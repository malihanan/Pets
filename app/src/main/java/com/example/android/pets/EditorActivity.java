...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int EXISTING_PET_LOADER = CatalogActivity.PET_LOADER;
    ...
    private void savePet() {
        ...
        if(mContentUri == null) {
            ...
            if (rowsUpdated == 0) {
                ...
                getApplicationContext().getContentResolver().notifyChange(mContentUri, null);
            }
        }
    ...
    private void deletePet() {
        if(mContentUri != null) {
            int rowsDeleted = getApplicationContext().getContentResolver().delete(mContentUri, null, null);
            if (rowsDeleted == 0) {
